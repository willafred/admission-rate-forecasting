...
# Generation of Lagged Dataset
COPD discharge case lag = 1
Asthma discharge case lag = 1
Environment lag = 1
...
# Regression Functions for Non-Exogenous Variables
...
# Analysis 2
```{r}
# submodels_asthma = regression_model_fn_without_exog(df_link = "combined_asthma_env_080225_norates.csv",outcome_var = "overall_rate_asthma",horizon=1,significant_predictors = asthma_significant_predictors_1) #2133HRS
