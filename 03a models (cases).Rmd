...
for (asthma_factor in all_asthma_cases_factors){
  for (horizon in 1:12){
    ...
    submodels_asthma = regression_model_fn_rawadmissions(df_link = "combined_asthma_env_080225_norates.csv",outcome_var = full_asthma_factor,horizon=horizon,significant_predictors = asthma_discharge_significant_predictors)
...
for (copd_factor in all_copd_cases_factors){
  for (horizon in 1:12){
    ...
    submodels_copd = regression_model_fn_rawadmissions(df_link = "combined_asthma_env_080225_norates.csv",outcome_var = full_copd_factor,horizon=horizon, significant_predictors = copd_discharge_significant_predictors)
